...
//creating a new key in the session and storing the total in it 
...
app.get('/send_to_log', function(req, res){
...
// app.post('/booking_page',function(req,res)
// {
...
// task 47
    ...
    con.connect((err)=>{
        ...
        {
            var query= "INSERT INTO logins(name, email ,password, phone , city, address) VALUES ?";
            var values = [
...
app.get("/verify_payment",function(req,res){
    ...
    var order_id=req.session.order_id;   //not taught
